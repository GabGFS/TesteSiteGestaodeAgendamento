    ...
    <main class="w-full bg-gray-100 py-1">
        <div class="w-full bg-white py-4 px-8">
            ...
            <div class="flex gap-6 overflow-x-auto no-scrollbar px-4">
                <?php
                $servicos = [
                    ['titulo'=>'Psicoterapia Individual','descricao'=>'Sessões individuais para autoconhecimento e desenvolvimento pessoal.','cor'=>'indigo','link'=>'contato.php','foto'=>'terapiaind.jpg'],
                    ['titulo'=>'Psicoterapia de Casal','descricao'=>'Ajuda para casais melhorarem comunicação e relacionamento.','cor'=>'pink','link'=>'contato.php','foto'=>'casalpsi.jpg'],
                    ['titulo'=>'Grupo de Apoio para Bariátricas','descricao'=>'Suporte emocional para pacientes no pré e pós-operatório.','cor'=>'green','link'=>'contato.php','foto'=>'grupo.jpeg'],
                    ['titulo'=>'Palestras','descricao'=>'Eventos sobre saúde mental e bem-estar psicológico.','cor'=>'purple','link'=>'contato.php','foto'=>'Palestra.png'],
                    ['titulo'=>'Orientação Profissional','descricao'=>'Auxílio na escolha e desenvolvimento de carreira.','cor'=>'yellow','link'=>'contato.php','foto'=>'ori.jpg']
                ];
                ...
                foreach($servicos as $servico){
                    ...
                    echo '<a href="'.$servico['link'].'" class="text-'.$servico['cor'].'-600 font-medium mt-3 hover:underline">Agendar</a>';
                    echo '</div>';
                    echo '</div>';
                }
                ?>
